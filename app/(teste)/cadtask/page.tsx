  ...
  useEffect(() => {
    ...
    const handleSubmit = async (event: Event) => {
      ...
      try {
        ...
        alert(
          "Erro ao cadastrar a tarefa. Verifique o console para mais informações."
        );
      }
    };
    ...
    <div className="container mt-5 mx-auto p-4">
      ...
      <form id="taskForm">
        ...
        <div className="mb-3 flex items-center">
          <input
            type="checkbox"
            className="form-check-input h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded mr-2"
            id="status"
          />
          <label
        ...
        <button
          type="submit"
          className="btn bg-indigo-600 text-white font-bold py-2 px-4 rounded hover:bg-indigo-700"
        >
          Cadastrar
        </button>
      </form>
